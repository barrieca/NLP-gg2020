...
gg_api.py. The return value of this function is then printed. As it is
...
It is expected that the main of gg_api.py will be called after the minimum
...
will be recreated (which will be time consuming). When running gg_apy.py a year
argument is required (i.e. $ python gg_apy.py <year>).
